const festivals = [
  ...
  },
  {
    ...
    description:
      'El Weekend Beach Festival es un festival de música que se celebra en la localidad costera de Torre del Mar, en la provincia de Málaga, España. Ofrece una amplia variedad de géneros musicales y actividades para los asistentes.',
    category: 'Mix',
    link: 'https://www.weekendbeach.es/'
  },
  {
    title: 'Download Festival Madrid',
    date: '2024-06-28',
    location: 'Madrid',
    description:
    ...
    category: 'Rock',
    link: 'https://downloadfestival.es/'
  }
];
